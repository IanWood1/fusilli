...
// TORCH-CHECK:       %dim_reduction_mul_0 = torch.constant.int 2
// TORCH-CHECK:       %keepdim_reduction_mul_0 = torch.constant.bool true
// TORCH-CHECK:       %dtype_reduction_mul_0 = torch.constant.none
// TORCH-CHECK:       %prod_reduction_mul_0 = torch.aten.prod.dim_int %arg0_input_reduction_mul_perm, %dim_reduction_mul_0, %keepdim_reduction_mul_0, %dtype_reduction_mul_0 : !torch.vtensor<[16,256,64,64],f32>, !torch.int, !torch.bool, !torch.none -> !torch.vtensor<[16,256,1,64],f32>
// TORCH-CHECK:       %dim_reduction_mul_1 = torch.constant.int 3
// TORCH-CHECK:       %keepdim_reduction_mul_1 = torch.constant.bool true
// TORCH-CHECK:       %dtype_reduction_mul_1 = torch.constant.none
// TORCH-CHECK:       %result_reduction_mul_perm = torch.aten.prod.dim_int %prod_reduction_mul_0, %dim_reduction_mul_1, %keepdim_reduction_mul_1, %dtype_reduction_mul_1 : !torch.vtensor<[16,256,1,64],f32>, !torch.int, !torch.bool, !torch.none -> !torch.vtensor<[16,256,1,1],f32>
