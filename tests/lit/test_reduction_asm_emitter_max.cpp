...
// TORCH-CHECK:       %arg0_input_x_reduction_max_perm = torch.aten.permute %arg0_input, %permute_X_reduction_max : !torch.vtensor<[16,256,64,64],f32>, !torch.list<int> -> !torch.vtensor<[16,256,64,64],f32>
...
// TORCH-CHECK:       %result_perm = torch.aten.amax %arg0_input_x_reduction_max_perm, %reduction_dims_reduction_max, %keepdim_reduction_max : !torch.vtensor<[16,256,64,64],f32>, !torch.list<int>, !torch.bool -> !torch.vtensor<[16,256,1,1],f32>
...
// TORCH-CHECK:       %result = torch.aten.permute %result_perm, %permute_Y_reduction_max : !torch.vtensor<[16,256,1,1],f32>, !torch.list<int> -> !torch.vtensor<[16,256,1,1],f32>
