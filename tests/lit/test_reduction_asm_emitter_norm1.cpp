...
// TORCH-CHECK:       %ord_reduction_norm1 = torch.constant.int 1
// TORCH-CHECK:       %keepdim_reduction_norm1 = torch.constant.bool true
// TORCH-CHECK:       %dtype_reduction_norm1 = torch.constant.none
// TORCH-CHECK:       %result_reduction_norm1_perm = torch.aten.linalg_vector_norm %arg0_input_reduction_norm1_perm, %ord_reduction_norm1, %reduction_dims_reduction_norm1, %keepdim_reduction_norm1, %dtype_reduction_norm1 : !torch.vtensor<[16,256,64,64],f32>, !torch.int, !torch.list<int>, !torch.bool, !torch.none -> !torch.vtensor<[16,256,1,1],f32>
