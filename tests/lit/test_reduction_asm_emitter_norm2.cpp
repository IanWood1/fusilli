...
// TORCH-CHECK:       %ord_reduction_norm2 = torch.constant.int 2
// TORCH-CHECK:       %keepdim_reduction_norm2 = torch.constant.bool true
// TORCH-CHECK:       %dtype_reduction_norm2 = torch.constant.none
// TORCH-CHECK:       %result_reduction_norm2_perm = torch.aten.linalg_vector_norm %arg0_input_reduction_norm2_perm, %ord_reduction_norm2, %reduction_dims_reduction_norm2, %keepdim_reduction_norm2, %dtype_reduction_norm2 : !torch.vtensor<[16,256,64,64],f32>, !torch.int, !torch.list<int>, !torch.bool, !torch.none -> !torch.vtensor<[16,256,1,1],f32>
