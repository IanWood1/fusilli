...
// TORCH-CHECK:       %arg0_input_x_reduction_sum_perm = torch.aten.permute %arg0_input, %permute_X_reduction_sum : !torch.vtensor<[16,256,64,64],f32>, !torch.list<int> -> !torch.vtensor<[16,256,64,64],f32>
...
// TORCH-CHECK:       %result_perm = torch.aten.sum.dim_IntList %arg0_input_x_reduction_sum_perm, %reduction_dims_reduction_sum, %keepdim_reduction_sum, %dtype_reduction_sum : !torch.vtensor<[16,256,64,64],f32>, !torch.list<int>, !torch.bool, !torch.none -> !torch.vtensor<[16,256,1,1],f32>
...
// TORCH-CHECK:       %result = torch.aten.permute %result_perm, %permute_Y_reduction_sum : !torch.vtensor<[16,256,1,1],f32>, !torch.list<int> -> !torch.vtensor<[16,256,1,1],f32>
...
static ErrorObject testReductionAsmEmitterSum(const std::string &mode) {
  ...
  // Manually set output dimensions to reduce spatial dims (H and W become 1)
